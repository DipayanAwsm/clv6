  ...
  return (
    <section className="space-y-5">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        ...
        <ChartCard
          title="CLV vs Behavior Score"
          subtitle="How value and behavior interact"
          helperText="Highlights pockets that need proactive retention and growth strategies."
        >
          <ResponsiveContainer width="100%" height="100%">
            <ScatterChart>
              <XAxis dataKey="riskScore" name="Behavior Score" />
              <YAxis dataKey="clv" name="CLV" />
              <Tooltip cursor={{ strokeDasharray: '3 3' }} />
              <Scatter data={data.segmentation.clvRiskScatter} fill="#2563eb" />
            </ScatterChart>
          </ResponsiveContainer>
        </ChartCard>
      </div>
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        ...
        <article className="space-y-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-soft dark:border-slate-800 dark:bg-slate-900">
          <h3 className="text-base font-semibold text-slate-900 dark:text-slate-100">Priority High-Value Customers</h3>
          <DataTable columns={topCustomerColumns as any} rows={data.segmentation.highRiskHighValue as any} />
        </article>
      </div>
